...
Note: To access any member of a structure, 
...
int main()
{
    ...
    strcpy(Book3.title, "Eloquent C");
    strcpy(Book3.author, "MaxBobo");
    strcpy(Book3.subject, "Programming in C");
    Book3.book_id = 6495222;
